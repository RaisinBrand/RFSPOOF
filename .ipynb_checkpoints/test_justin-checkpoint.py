...
#folder_path = '/home/jfeng/Desktop/jfeng/rf_spoofing/spoofing/justin/May1/concat_test1'
#folder_path = '/home/jfeng/Desktop/jfeng/rf_spoofing/spoofing/justin/Apr27/test1'
#folder_path = '/home/jfeng/Desktop/jfeng/rf_spoofing/spoofing/testbed/iq/May1'
folder_path = '/home/jfeng/Desktop/jfeng/rf_spoofing/spoofing/testbed/iq/Apr27'
for filename in os.listdir(folder_path):
    ...
    file_name = file_path
    #file_name = f"./justin/pluto0_4m.iq"
    #file_name = f"./testbed/test_sample_noise.iq"
    #file_name = f"./justin/baseline/empty.iq"
    #file_name = f"./1m_2m_replacedPluto4/1m_2m/Pluto_0_2m_run0.iq"
    #file_name = f"/data2/brandan/RFSPOOF/brandan_4_1/2m_adv2m_eot.iq"
    #file_name = f"/data2/brandan/RFSPOOF/brandan_4_1/2m_adv2m_eot.iq"
    #file_name = f"./justin/2m_pluto_0.iq"
    #file_name = f"./justin/generative/4m_0,1,3,4.iq"
    target = 1
